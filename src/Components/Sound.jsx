...
//サウンドのインポート
import r1s0 from '../Sounds/s/keySound0.wav'
import r1s1 from '../Sounds/s/keySound1.wav'
import r1s2 from '../Sounds/s/keySound2.wav'
import r1s3 from '../Sounds/s/keySound3.wav'
import r1s4 from '../Sounds/s/keySound4.wav'
import r1s5 from '../Sounds/s/keySound5.wav'
import r1s6 from '../Sounds/s/keySound6.wav'
import r1s7 from '../Sounds/s/keySound7.wav'
import r1s8 from '../Sounds/s/keySound8.wav'
import r1s9 from '../Sounds/s/keySound9.wav'
import r2s0 from '../Sounds/s/keyS20.wav'
import r2s1 from '../Sounds/s/keyS21.wav'
import r2s2 from '../Sounds/s/keyS22.wav'
import r2s3 from '../Sounds/s/keyS23.wav'
import r2s4 from '../Sounds/s/keyS24.wav'
import r2s5 from '../Sounds/s/keyS25.wav'
import r2s6 from '../Sounds/s/keyS26.wav'
import r2s7 from '../Sounds/s/keyS27.wav'
import r2s8 from '../Sounds/s/keyS28.wav'
import r2s9 from '../Sounds/s/keyS29.wav'
...
export const Sound = forwardRef(({ round } , ref) => {
    const [play_r1s0] = useSound(r1s0, { volume: 0.4});
    const [play_r1s1] = useSound(r1s1, { volume: 0.4});
    const [play_r1s2] = useSound(r1s2, { volume: 0.4});
    const [play_r1s3] = useSound(r1s3, { volume: 0.4});
    const [play_r1s4] = useSound(r1s4, { volume: 0.4});
    const [play_r1s5] = useSound(r1s5, { volume: 0.4});
    const [play_r1s6] = useSound(r1s6, { volume: 0.4});
    const [play_r1s7] = useSound(r1s7, { volume: 0.4});
    const [play_r1s8] = useSound(r1s8, { volume: 0.4});
    const [play_r1s9] = useSound(r1s9, { volume: 0.4});
    const [play_r2s0] = useSound(r2s0, { volume: 3 });
    const [play_r2s1] = useSound(r2s1, { volume: 3 });
    const [play_r2s2] = useSound(r2s2, { volume: 3 });
    const [play_r2s3] = useSound(r2s3, { volume: 3 });
    const [play_r2s4] = useSound(r2s4, { volume: 3 });
    const [play_r2s5] = useSound(r2s5, { volume: 3 });
    const [play_r2s6] = useSound(r2s6, { volume: 3 });
    const [play_r2s7] = useSound(r2s7, { volume: 3 });
    const [play_r2s8] = useSound(r2s8, { volume: 3 });
    const [play_r2s9] = useSound(r2s9, { volume: 3 });
    ...
    const [playPractice] = useSound(pras0, { volume: 0.1 });
    const [playBeep] = useSound(beepSound, { volume: 0.05 });
